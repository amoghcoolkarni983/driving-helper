...
public class ReportBuilder implements ITestListener {
	...
	private static Logger logger = LogManager.getLogger(ReportBuilder.class);

	public static ExtentReports init(String suiteName, String browserType) {
		DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss");
		Calendar cal = Calendar.getInstance();
		String filepath = "Reports/" + suiteName + "_Test_Results_" + dateFormat.format(cal.getTime()) + ".html";
...
//		extent.setSystemInfo("Host Name", System.getenv("COMPUTERNAME").toUpperCase());
	...
	public static String takesScreenshot() {
		/*String encodedImage=((TakesScreenshot)driver).getScreenshotAs(OutputType.BASE64);
		...
		try {
			...
			System.out.println("getScreenstho is "+((TakesScreenshot) driver).getScreenshotAs(OutputType.BASE64));
